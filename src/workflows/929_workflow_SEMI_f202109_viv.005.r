...
FEintra_manual_base <- function( pinputexps )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/1301_FE_intrames_manual_015.r"
...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$train$training <- c(202105, 202104, 202103, 202102, 202101,
                                  202012, 202011, 202010, 202009, 202008, 202007, 202006, 202005, 202004, 202003, 202002, 202001, 201912, 201911, 201910, 201909, 201908, 201907,
                                  201906, 201905)
...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    lambda_l1 = c(0.0,1500.0), # lambda_l1 >= 0.0
    lambda_l2 = c(0.0,1500.0), # lambda_l2 >= 0.0
...
wf_SEMI_sep <- function( pnombrewf )
{
  ...
  fm <- FM_final_models_lightgbm_semillerio( 
    ...
    semillerio = 40,   # cantidad de semillas finales
    repeticiones_exp = 1 )
